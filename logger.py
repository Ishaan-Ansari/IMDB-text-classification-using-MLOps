...
loggerDI = setup_logger("DataIngestion")
loggerDP = setup_logger("DataPreprocessing")
loggerFE = setup_logger("FeatureEngineering")
loggerMT = setup_logger("ModelTraining")
loggerME = setup_logger("ModelEvaluation")
loggerMR = setup_logger("ModelRegistry")